...
export default function AboutSection({ setActiveTab, onOpenCV }) {
  ...
  return (
    <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-16">
      ...
      {/* 2. Doctoral Supervision & Board of Studies (BOS) Leadership */}
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        
        {/* Ph.D. Research Supervision Card (6 cols) */}
        <div className="lg:col-span-6 bg-gradient-to-br from-emerald-950 via-slate-900 to-slate-950 rounded-3xl p-6 sm:p-8 text-white border border-emerald-500/30 shadow-md relative overflow-hidden">
        ...
        <div className="lg:col-span-6 bg-gradient-to-br from-indigo-950 via-slate-900 to-slate-950 rounded-3xl p-6 sm:p-8 text-white border border-indigo-500/30 shadow-md relative overflow-hidden">
      ...
      <section className="bg-gradient-to-b from-slate-50 to-white rounded-3xl p-6 sm:p-10 border border-slate-200/80 shadow-sm">
      ...
      <section id="faculty-development" className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200/80 shadow-sm scroll-mt-20">
      ...
      <section id="professional-memberships" className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200/80 shadow-sm scroll-mt-20">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
          <div>
